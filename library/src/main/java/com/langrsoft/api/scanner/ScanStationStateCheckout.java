...
public class ScanStationStateCheckout extends AbstractScanStationState
    ...
    public void scanHolding(String holdingId) {
        ...
        scanner.getLibrarySystem().checkOut(scanner.getPatronId(), holdingId, checkoutTime);
    ...
    public void pressComplete() {
        ...
        scanner.showMessage(String.format(MSG_COMPLETED_CHECKOUT, scanner.getPatronId()));
    }
}
